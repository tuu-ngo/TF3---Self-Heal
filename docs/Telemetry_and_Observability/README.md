...
Telemetry_and_Observability/
  M6-IaC_Observability_v5.2.md      
  telemetry_data_flow.md
  picture/
...
|---|---|
| `M6-IaC_Observability_v5.2.md` | Prometheus -> Alertmanager -> Forwarder -> SQS -> Executor -> AI -> Audit |
| `telemetry_data_flow.md` | Luồng data telemetry và observability hiện tại |
